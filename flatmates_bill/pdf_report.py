...
class PdfReport:
    ...
    the flatmates such as names, due amounts and period of the bill
    """
    ...
    def generate(self, flatmate1, flatmate2, bill):
        ...
        # Change directory of files. Generate and open PDF.
        os.chdir("files")
...
class FileSharer:
    ...
    def __init__(self, filepath, api_key='AiuxYN5o0QKyyGY95V6n4z'):
